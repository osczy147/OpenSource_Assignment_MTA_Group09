...
1. **Clone the repository**
   ```bash
   git clone https://github.com/[osczy147]/OpenSource_Assignment_MTA_Group09.git
   cd OpenSource_Assignment_MTA_Group09
   ```
...
4. **Delete the installer** (security best practice)
   ```bash
